    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          Align(child: Row(children: [Icon(FontAwesomeIcons.rupeeSign,size: 13,),Text("20,000")],),alignment: Alignment.center,),
          ...
          bottomNavigationBar: new SizedBox(
            ...
            child: TabBar(
              ...
              tabs: [
                ...
                Column(
                  children: <Widget>[
                    new Icon(FontAwesomeIcons.firstOrder
                    ),
                    new Text(
                      "Sell",
                      style: TextStyle(fontSize: 12),
